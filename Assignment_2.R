...
# 1.
#data data=c(90,95,89,71,73,96,87,95,107,89,96,80,97,95,102,97,93,101,82,83,74,91,83,98,95,111,99,120,93,84)
1-a.
#sample mean
xbar=mean(data)
...
3.
a. (F) We do not have any idea of the size of effect of the treatment from this test. We only have information whether this treatment has effect.
b. (T) We can reject the null hypothesis in a significance level of 5%, so this treatment has some effect.
c. (F) This is a false sentence because we have a danger of reject in probability of size of significance level.
d. (F) This is not correct. We cannot derive the Type 2 error from the test.
e. (T) The null hypothesis could not reject in a significance level of 1% cause the p-value is 0.04
